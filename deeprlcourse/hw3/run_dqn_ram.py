...
def main():
    # Run training
    seed = 136 # Use a seed of zero (you may want to randomize the seed!)
    env = get_env(seed)
    session = get_session()
    atari_learn(env, session, num_timesteps=int(4e7), dir_name='/Users/anil/Code/ai/deeprlcourse/hw3/dqn/ram/')
